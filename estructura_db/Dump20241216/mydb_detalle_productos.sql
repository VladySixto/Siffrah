...
CREATE TABLE `detalle_productos` (
  ...
  KEY `fk_detalle_productos_pedido1_idx` (`pedido_id_pedido`),
  CONSTRAINT `fk_detalle_productos_pedido1` FOREIGN KEY (`pedido_id_pedido`) REFERENCES `pedido` (`id_pedido`)
...
-- Dump completed on 2024-12-16 12:33:11
